<div id="sidebar" class="nav-collapse collapse">
    ...
    <ul class="sidebar-menu">
        ...
        <li <?php if(isset($gb)) echo $gb;?>>
            <?=anchor('guestbook/read', '<span class="icon-box"><i class="icon-envelope"></i></span> Kotak Masuk');?>
        </li>
        ...
        <li class="has-sub <?php if(isset($tools)) echo $tools;?>">
            ...
            <ul class="sub">
                ...
                <li><?=anchor('dashboard/user_guide', 'User Guide');?></li>
        ...
        <li class="has-sub <?php if(isset($ppdb)) echo $ppdb;?>">
            ...
            <ul class="sub">
                ...
                <li <?php if(isset($statistik)) echo $statistik;?>><?=anchor('statistik', 'Statistik Pendaftaran');?></li>
            </ul>
        </li>
        
        <li <?php if(isset($gb)) echo $gb;?>>
            <?=anchor('guestbook/create', '<span class="icon-box"><i class="icon-comments-alt"></i></span> Hubungi Kami');?>
        </li>
        
        <li>
            <?=anchor('login', '<span class="icon-box"><i class="icon-user"></i></span> Log In');?>
        </li>
